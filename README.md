...
- Interactive button to trigger color changes.
...
2. When the button (`#btn`) is clicked:
   ...
   - The background color of the page (`<body>`) is updated.
   - The hex code is displayed inside the element with ID `#bg-hex-code`.
